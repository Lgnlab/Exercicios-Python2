...
#para isto você deve fazer um programa que pergunte a cada um dos clientes da academia. O seu código, sua altura e seu peso.
...
while True:
    codigo = int(input('Código do aluno (0 para parar): '))
    if codigo == 0:
        break
